%% FOM_MGS2 method for PageRank computation, solving (I-A)x=0 
...
function [x0,it,solving_time,mv,res,res1,res2]=FOM_MGS2_pagerank_func(G,alpha,tol,m,maxit,all_res)
weighted_FOM_global
